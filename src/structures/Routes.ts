...
export class Routes {
    ...
    private validateCommandSnowflake(commandId: Snowflake): void {
        if (!commandId || typeof commandId !== 'string') {
            throw new ReferenceError(
                '[@antibot/interactions#Routes] Command ID must be a Snowflake.',
            );
        }
    }
    ...
    private validateGuildSnowflake(guildId: Snowflake): void {
        if (!guildId || typeof guildId !== 'string') {
            throw new ReferenceError(
                '[@antibot/interactions#Routes] Guild ID must be a Snowflake.',
            );
        }
    }
    ...
    public getGuildApplicationCommand(options: {
    ...
    public editGuildApplicationCommand(options: {
        applicationId: Snowflake;
        guildId: Snowflake;
        commandId: Snowflake;
    }): string {
    ...
    public deleteGuildApplicationCommand(options: {
        applicationId: Snowflake;
        guildId: Snowflake;
        commandId: Snowflake;
    }): string {
    ...
    public getApplicationCommandPermissions(options: {
        applicationId: Snowflake;
        guildId: Snowflake;
        commandId: Snowflake;
    }): string {
    ...
    public editApplicationCommandPermissions(options: {
        applicationId: Snowflake;
        guildId: Snowflake;
        commandId: Snowflake;
    }): string {
    ...
    public batchEditGuildApplicationCommandPermissions(
        applicationId: Snowflake,
        guildId: Snowflake,
    ): string {
        this.validateApplicationSnowflake(applicationId);
